...
loginUserDecoder =
    decode User
        |> required "me" (Decode.field "email" Decode.string)
        |> required "token" AuthToken.decoder
        |> required "me" (Decode.field "name" usernameDecoder)
        |> required "me" (Decode.field "bio" (Decode.nullable Decode.string))
        |> required "me" (Decode.field "image" UserPhoto.decoder)
