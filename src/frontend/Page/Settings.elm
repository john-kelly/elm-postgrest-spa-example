...
import Html.Attributes exposing (attribute, class, defaultValue, placeholder, type_, disabled)
...
update session msg model =
    case msg of
        SubmitForm ->
            case (validate model, session.user) of
                ([], Just user) ->
                    Request.User.edit model user.username user.token
